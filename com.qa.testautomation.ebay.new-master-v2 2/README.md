...
3. From the shell/command-line 
    ...
    2. Run “mvn test”
    3. You should get a build success result, showing undefined test ebay.qa.testautomation.steps
...
6. To run your tests, from the shell/command-line use command:
    1. mvn -Dtest=ebay.qa.testautomation.TestRunner -Dcucumber.options="--tags @001" test - note that ‘@001’ is the tag name of the test scenarios provided in the .feature file
